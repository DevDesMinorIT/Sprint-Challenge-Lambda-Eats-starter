...
## Similar to <Route>, where matching the browser URL occurs. This functionality occurs without a rendering phase.  
2. How would you explain form validation to someone who has never programmed before?
## A set of required user input accecptions that when met allow for the form to be submitted/saved/archived
3. In 1-2 sentences, define end to end testing.
## A technique which simualates the User Experience from begin to end documenting if certain conditions are met and key elements have been included. Issue/bug free code is the culmination of this thorough testing methodology. 
